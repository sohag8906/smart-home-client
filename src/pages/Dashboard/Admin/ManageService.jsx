  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Add, edit or remove services from your system</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 mb-6 shadow-sm">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          <div className="mb-3 md:mb-0">
            ...
            <p className="text-gray-600 text-sm mt-1">Create a new service for your customers</p>
          </div>
          <button
